...
def open_cal():
    ...
    button_clear = Button(top, text="Clear", padx=79, pady=20, command=button_clear)

    button_subtract = Button(top, text="-", padx=41, pady=20, command=button_subtract)
    button_multiply = Button(top, text="*", padx=40, pady=20, command=button_multiply)
    button_divide = Button(top, text="/", padx=41, pady=20, command=button_divide)
...
lb1 = Button(root,command=open_cal, text='Open Calculation').pack()
